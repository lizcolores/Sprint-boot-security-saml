...
public class CombinedUserDetailsService implements UserDetailsService, SAMLUserDetailsService {
    ...
    //The method is supposed to identify local account of user referenced by data in the SAML
    //assertion and return UserDetails object describing the user.
    @Override
    public Object loadUserBySAML(SAMLCredential credential) throws UsernameNotFoundException {
        LOGGER.info("Loading UserDetails by SAMLCredentials: {}", credential.getAttributes());
        //List<Attribute> attributesFromAttributeStatement = credential.getAttributes();
